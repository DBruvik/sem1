#Program for å beregene farge på tall på ruletten

#Alternativ 3, tar utgangsåunkt i hvilke farger gjelder for
#hvilke intervaller og "talltype"

#En test på farge, dvs sann/usann på if-test nr 3
#Kan da ikke si om tallet er partall eller oddetall eller hvilket intervall
#det tilhører, kun farge.
